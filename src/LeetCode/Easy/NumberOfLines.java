...
//        char[] alphabetsToChar = alphabets.toCharArray();
//        Map<Character, Integer> alphabetPixelsMap = new HashMap<>();
//
//        for (int i = 0; i < alphabetsToChar.length; i++) {
//            if (!alphabetPixelsMap.containsKey(alphabetsToChar[i])) {
//                alphabetPixelsMap.put(alphabetsToChar[i], widths[i]);
//            }
//
//        }
//        return alphabetPixelsMap;
//    }
//
//    public static void main(String[] args) {
//        String s = "abcdefghijklmnopqrstuvwxyz";
//        int[] width = {4,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10};
//        NumberOfLines res = new NumberOfLines();
//        System.out.println(res.numberOfLines(width,s));
//    }
//}
