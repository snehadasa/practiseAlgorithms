...
//    It is guaranteed that s is a valid roman numeral in the range [1, 3999].
    ...
    public int romanToInt(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            int digit1 = roman(s.charAt(i));
            if (i+1 < s.length()) {
                int digit2 = roman(s.charAt(i+1));
    ...
    public static void main(String[] args) {
        ...
        String s4 = "IV";
        String s5 = "IX";
        RomanToInt res = new RomanToInt();
        System.out.println(res.romanToInt(s1));
        System.out.println(res.romanToInt(s2));
        System.out.println(res.romanToInt(s3));
        System.out.println(res.romanToInt(s4));
        System.out.println(res.romanToInt(s5));
    }
}
