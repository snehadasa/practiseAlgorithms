...
//
//    The complement of a binary representation is the number in binary you get when changing every 1 to a 0 and 0 to
//    a 1.  For example, the complement of "101" in binary is "010" in binary.
//
...
//    This question is the same as 476: https://leetcode.com/problems/number-complement/
    ...
    public int bitwiseComplement(int N) {
        String numN = Integer.toString(N, 2);
    ...
    public static void main(String[] args) {
        int N = 5;
        BitwiseComplement res = new BitwiseComplement();
        System.out.println(res.bitwiseComplement(N));
    }
}
