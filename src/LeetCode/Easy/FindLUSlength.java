...
//
//    Return the length of the longest uncommon subsequence between a and b. If the longest uncommon subsequence
...
//    Input: a = "aaa", b = "aaa"
//    Output: -1
//    Explanation: Every subsequence of string a is also a subsequence of string b. Similarly, every subsequence of
...
//    a and b consist of lower-case English letters.
    ...
    public static void main(String[] args) {
        String a = "aba";
        String b = "cdc";
        FindLUSlength res = new FindLUSlength();
        System.out.println(res.findLUSlength(a,b));
    }
}
