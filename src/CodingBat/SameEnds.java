...
//        int[] nums1 = {5, 6, 45, 99, 13, 5, 6};
        int len1 = 1, len2 = 2, len3 = 3;
        SameEnds res = new SameEnds();
        System.out.println(res.sameEnds(nums, len1));
        System.out.println(res.sameEnds(nums, len2));
        System.out.println(res.sameEnds(nums, len3));
    }
}
